...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                // Unauthenticated requests → 401 (not the Spring default 403), so the
                // frontend can tell "no/expired token" apart from "logged in but forbidden"
                // and auto-redirect to login. Access-denied for authenticated users stays 403.
